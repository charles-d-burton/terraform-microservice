...
Run the following commands to push the docker image to the repo, replacing the 352484006547.dkr.ecr.us-west-2.amazonaws.com/docker-mongo:latest with the what was generated by Terraform.
